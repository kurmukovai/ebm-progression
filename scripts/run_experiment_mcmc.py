...
if __name__=="__main__":
    ...
    np.save('../logs/order_greedy_ascent.npy', np.array(order))
    np.save('../logs/loglike_greedy_ascent.npy', np.array(loglike))
    np.save('../logs/update_iters_greedy_ascent.npy', np.array(update_iters))
